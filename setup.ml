...
(* OASIS_START *)
(* DO NOT EDIT (digest: 1fe57c9436b8f338a62190ec979f9b3a) *)
(*
...
let setup_t =
  {
       ...
       [
          ...
          ("thread_benchmark",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$thread_benchmark", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              })
       ];
            ...
            [
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_c_sources = ["hvsock_stubs.c"; "compat.h"];
                      bs_data_files = [];
                   ...
                   },
                   {
                      lib_modules =
                        [
                           "Lwt_hvsock";
                           "Flow_lwt_hvsock";
                           "Flow_lwt_hvsock_shutdown"
                        ];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "hvsock";
               ...
               Library
                 ({
                   ...
                   },
                   {
                      lib_modules =
                        [
                           "Flow_lwt_unix_hvsock";
                           "Flow_lwt_unix_hvsock_shutdown";
                           "Flow_lwt_unix_time";
                           "Lwt_hvsock_detach";
                      ...
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "hvsock";
                      lib_findlib_name = Some "lwt-unix";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Doc
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "hvsock";
                           InternalLibrary "hvsock_lwt";
                           InternalLibrary "hvsock_lwt_unix";
                           FindlibPackage ("lwt", None);
                   ...
                   {exec_custom = false; exec_main_is = "hvcat.ml"});
               Executable
                 ({
                     cs_name = "test";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("logs.fmt", None);
                           FindlibPackage ("lwt.preemptive", None);
                           FindlibPackage ("uwt", None);
                           FindlibPackage ("uwt.preemptive", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                   ...
                   {exec_custom = false; exec_main_is = "thread_benchmark.ml"
                   });
               Test
                 ({
                     cs_name = "thread_benchmark";
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\205 \140\206\019<ks\223a!\026G\223\192\136";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
