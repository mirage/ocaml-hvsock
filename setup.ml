...
(* OASIS_START *)
(* DO NOT EDIT (digest: 6a7ea34859af1bc30b515bad355da683) *)
(*
...
let setup_t =
  {
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("unix-type-representations", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "¶)\138áfEZ\016\000X¯Íá¥\155\"";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
